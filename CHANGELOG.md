...
- Create Angular project with ng: `ng new sendbol_videoshop.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`sendbol_videoshop.client.esproj`).
